...
namespace constructions
{
    ...
    {
        public static Dictionary<string, (double X, double Y)> points = new Dictionary<string, (double X, double Y)>();
        ...
        public static double angelA(double b,double c,double angel) { return Math.Sqrt(b * b + c * c -2*b*c* Math.Cos(angel)); }
        ...
        public static void new_point_measure(string name, double x1, double y1, double x2, double y2, double D1, double D2, double a)// (a=b^2+c^2-a^2)/2ab 
        {
            ...
            double x;
            double y;
            //m1 :ميل المستقيم ac,m0: ميل المستقيم ab,a: الزاوية cab,x1,y1 : احداثيات المرجع الاول,x2,y2 احداثيات المرجغ الثاني
        ...
        public static void STORE_POINT(string name, double X, double Y)
        {
            int n = points.Count + 1;
            points.Add(name + n.ToString(), (X, Y));   
          name= name + n.ToString();
